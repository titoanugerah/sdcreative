                        ...
                        <tbody>
                          <?php $i=1;foreach ($content['order'] as $item): if($item->status!=2){continue;} ?>
                            <tr>
                              ...
                              <td><?php if($item->status==2){echo 'Belum dikonfirmasi';} ?></td>
                    ...
                    <div class="bd-example">
                      <div class="table-responsive">
                        <table id="multi-filter-select1" class="display table table-striped table-hover" cellspacing="0" width="100%">
                          ...
                          <tbody>
                            <?php $i=1;foreach ($content['order'] as $item): if(($item->need_hardfile==1 && $item->status<3 || $item->status>14) ||
                              ($item->need_hardfile==0 && $item->status<3 || $item->status>12)){continue;} ?>
